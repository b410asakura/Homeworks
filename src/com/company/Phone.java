...
public class Phone {
    ...
    public void call(String code, String  number, double minute){
        double callPriceSim1 = sim1.getCallPrize(code, minute);
        double callPriceSim2 = sim2.getCallPrize(code, minute);

        if (callPriceSim1 < callPriceSim2) System.out.println("using sim1");
